...
def scream(update: Update, context: CallbackContext) -> None:
    ...
    print(f'{update.message.from_user.first_name} pressed scream Screaming is now {screaming}')
...
def whisper(update: Update, context: CallbackContext) -> None:
    ...
    global screaming
    screaming = False
    print(f'{update.message.from_user.first_name} pressed whisper Screaming is now {screaming}')
